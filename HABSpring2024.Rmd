...
lib_ins <- c(1,999) # data up through end of 2022; this is the training set
lib_oos <- c(1000,1173) # leave this alone until we're nearly done with the project
...
dummy_data <- data.frame(E = NA, rho = NA)

# Plotting
ggplot() + 
  geom_line(data = rho_E, aes(x = E, y = rho, color = "AR = 1"), linetype = "solid") +
  geom_hline(data = dummy_data, aes(yintercept = stats_AR$rho, color = "EDM Tau = 1"), linetype = "dashed") +
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Phycocanin Tau = 1 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 1", "AR = 1")) +
  theme_minimal()
...
preds_AR <- SMap(dataFrame = morndf_CR, columns = "phy", target = "phy",
lib = lib_ins, pred = lib_ins, E=1,theta=0,tau=-tau_i,Tp=tau_i) #lib 
...
# Plotting
ggplot() + 
  geom_line(data = rho_E_tau_i_0, aes(x = E, y = rho, color = "AR = 1"), linetype = "solid") +
  geom_hline(data = dummy_data, aes(yintercept = stats_AR$rho, color =  "Tau = 2"), linetype = "dashed") +
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Phycocanin Tau = 2 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 2", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  geom_line(data = rho_E, aes(x = E, y = rho, color = "AR = 1"), linetype = "solid") +
  geom_hline(data = dummy_data, aes(yintercept = stats_AR$rho, color =  "Tau = 4"), linetype = "dashed") +
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Phycocanin Tau = 4 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 4", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  geom_line(data = rho_E, aes(x = E, y = rho, color = "AR = 1"), linetype = "solid") +
  geom_hline(data = dummy_data, aes(yintercept = stats_AR$rho, color ="Tau = 1"), linetype = "dashed") +
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Chlorophyll Tau = 1 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 1", "AR = 1")) +
  theme_minimal()
...
# we can use S-map with E=1 and theta=0 to get the AR(1) forecast skill
preds_AR <- SMap(dataFrame = morndf_CR, columns = "chl", target = "chl",
lib = lib_ins, pred = lib_ins, E=1,theta=0,tau=-tau_i,Tp=tau_i) #lib train, #pred is pred 
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Chlorophyll Tau = 2 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 2", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "9 AM - 12 PM Chlorophyll Tau = 4 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 4", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "Daily Chlorophyll Tau = 1 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 1", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "Daily Chlorophyll Tau = 2 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 2", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "Daily Phycocanin Tau = 1 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 1", "AR = 1")) +
  theme_minimal()
...
ggplot() + 
  ...
  ylim(0, 1) +
  labs(x = "Embedding Dimension", y = "Prediction Skill (p)", color = "Lines") + 
  ggtitle( "Daily Phycocanin Tau = 2 V. AR = 1") +
  scale_color_manual(values = c("blue", "black"), labels = c("Tau = 2", "AR = 1")) +
  theme_minimal()
