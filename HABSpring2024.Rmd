...
df_example <- data.frame(seq(as.Date("2015-01-01"),by=1,length.out=5000))
df_example <- data.frame(Date=seq(as.Date("2015-01-01"),by=1,length.out=5000))
...
merged_df <- merge(ag_df_CR, cycle, by.x = "date", by.y = "Date", all.x = TRUE)

ag_df_CR <- merged_df %>% select(-10)
...
find out multivariate CSO - reflects and episodic threshold reponse to
weather
