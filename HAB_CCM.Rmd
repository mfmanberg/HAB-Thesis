...
cmap.ph.del <- CCM(dataFrame = ag_df_CR, E = 4, Tp = 0, columns = "ph", target = "del_phy", libSizes = "20 200 10", sample = 100, showPlot = TRUE)

cmap.ph.phy <- CCM(dataFrame = ag_df_CR, E = 4, Tp = 0, columns = "ph", target = "phy", libSizes = "20 200 10", sample = 100, showPlot = TRUE)
