...
LM and GAM relaxes linearity 
can say wether term is linear or spline
whether error distribution is 

Difference between GAM and LM is GAM works with non gaussion
can use GAM to fit GM by saying distribution is normal 
whether response variable is linear or non-linear 
...
use gaussian or gamma, not count
...
Gamma(link = "inverse") 0 bound contious distribution 
page 79
...
### GAM (Generalized Additive Model)
GAM has same choice of families 
specify what varaibles you want to be smoothed 
MGCV package
challenge2021_manuscript.Rmd
put s what you want to be splined 
method REML default 
add family if you want 
...
### 6.4 Gap filled predicted mean
>>>>>>> 7d2007589583dea1d6749bf341115c383b32c474
