...
#finish s-map + simplex predictions 

#look at max paper time periods of predictions
...
target = "chl", lib = "1 1075", pred = "1076 1223", E = E)
...
columns = "chl", E = 2)
ComputeError(ag_df_CRPredict$Observations, ag_df_CRPredict$Predictions)$rho
...
cmap <- CCM(dataFrame = ag_df_CR, E = 3, Tp = 0, columns = "chl", target = "turb", libSizes = "10 70 5", sample = 100, showPlot = TRUE)
...
head(ag_df_CR)
smap_CR <- SMap(dataFrame = ag_df_CR, lib = "1 500", pred = "601 900", E = 2,
theta = 3, columns = "chl phy ph Celsius spcond do turb", target = "chl", embedded = TRUE)
```
